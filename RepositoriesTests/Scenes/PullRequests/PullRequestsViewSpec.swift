    ...
    override func spec() {
        fdescribe("PullRequests View Controller") {
            fcontext("load view") {
                ...
                let pullRequestsViewController = storyboard.instantiateViewControllerWithIdentifier("PullRequestsViewController") as! PullRequestsViewController
                ...
                fit("started refresh pullRequests") {
                    expect(pullRequestsViewController.refreshControl.refreshing).to(beTruthy())
                }
            }
        }
    }
